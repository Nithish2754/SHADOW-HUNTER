...
# Config is read-only at /app/config â€” write user edits to /app/data instead
...
# â”€â”€ Stats & Hits API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Seeds API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Clearnet Seeds API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

def _load_clearnet_seeds() -> list[str]:
    if not CLEARNET_SEEDS_FILE.exists():
        return []
    return [line.strip() for line in CLEARNET_SEEDS_FILE.read_text(encoding="utf-8").splitlines()
            if line.strip() and not line.strip().startswith("#")]
...
def _load_paste_sources() -> list[str]:
    if not PASTE_SOURCES_FILE.exists():
        return []
    return [line.strip() for line in PASTE_SOURCES_FILE.read_text(encoding="utf-8").splitlines()
            if line.strip() and not line.strip().startswith("#")]
...
# â”€â”€ Paste Sources API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Keyword bulk import/export â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Keyword generator â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€


@dashboard_bp.route("/api/keywords/generate", methods=["POST"])
@require_login
def api_keywords_generate():
    """Rule-based keyword generator â€” zero API cost."""
    body = request.get_json() or {}
    ...
    if name:
        ...
        # Common typos â€” swap adjacent chars in short names
    ...
    if domain:
        ...
        for suffix in ["breach", "hacked", "attacked", "compromised", "data", "exposed", "stolen"]:
    ...
    # â”€â”€ Industry-specific terms â”€â”€
    industry_keywords = {
    ...
    # â”€â”€ Context extraction â€” pull meaningful words/phrases â”€â”€
    if context:
        import re as _re
    ...
    # Clean up â€” remove empty strings, sort each category
    final = {}
...
# â”€â”€ Crawl control API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ User management API (admin only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ User settings API (own account) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Telegram Channels API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def _load_channels() -> list[str]:
    ...
    return [
        line.strip().lstrip("@")
        for line in TELEGRAM_CHANNELS_FILE.read_text(encoding="utf-8").splitlines()
        if line.strip() and not line.strip().startswith("#")
    ]
...
# â”€â”€ Sessions API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ PDF Report API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def api_report_pdf():
    try:
        ...
        if session_id_filter:
            ...
            report_title = f"Session #{session_id_filter} â€” Threat Intelligence Report"
        else:
        ...
        # â”€â”€ Executive summary stats â”€â”€
        ...
        for s in sessions[:15]:
            started = s["started_at"][:16].replace("T", " ") if s.get("started_at") else "â€”"
            sess_data.append([started, s.get("status") or "â€”", str(s.get("pages_crawled") or 0), str(s.get("hits_found") or 0)])
        ...
        # â”€â”€ Keyword hits detail â”€â”€
        if hits:
            story.append(Paragraph(f"Keyword Hits Detail (latest {len(hits)})", s_h2))
            hits_data = [["Keyword", "Category", "URL", "Context", "Found At"]]
            for h in hits:
                found = h.found_at.strftime("%m-%d %H:%M") if h.found_at else "â€”"
                ctx = (h.context or "")[:120] + ("â€¦" if len(h.context or "") > 120 else "")
                hits_data.append([
        ...
        story.append(Paragraph(
            "CONFIDENTIAL â€” This report contains sensitive threat intelligence data. "
...
# â”€â”€ Investigations API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ IP Investigation API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Threat Actors API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€




# â”€â”€ Digest / Mailing List API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def api_digest_preview():
    ...
    try:
        ...
        scanner_summary = {
            ...
            "top_keyword": top_kw[0].get("keyword", "â€”") if top_kw else "â€”",
        }
...
def api_public_subscribe():
    """Public endpoint â€” no auth required. For static website subscribe form."""
    from ..digest import add_subscriber
    body = request.get_json() or {}
    email = (body.get("email") or "").strip().lower()
...
# â”€â”€ DNS Crawler API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def api_dns_enrich(inv_id: int):
    ...
    # â”€â”€ Call DNSDumpster API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    try:
        _dn = safe_fetch(
    ...
    # â”€â”€ Merge into existing result â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # Merge into subdomains_resolved â€” deduplicate by subdomain name
...
def api_dns_certs(domain: str):
    ...
    # Query crt.sh â€” use the deduplicated JSON endpoint
    try:
        _result = safe_fetch(
    ...
    for entry in raw:
        ...
        # Parse dates â€” crt.sh uses both "2024-01-01T00:00:00" and "2024-01-01" formats
...
def api_dns_pdf(inv_id: int):
    """Export DNS investigation as a rich PDF report â€” DNSDumpster-inspired layout."""
    from io import BytesIO
    from datetime import datetime as dt
    from collections import Counter
    ...
    # â”€â”€ ASN / hosting breakdown â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    asn_counter = Counter()
    org_counter = Counter()
    ...
    # â”€â”€ matplotlib helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ GRAPH: subdomain node diagram â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ GRAPH: world map via Playwright + jsvectormap â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    def build_world_map():
        """Screenshot the real jsvectormap using Playwright â€” same map as the dashboard."""
        import json as _json
...
window._ready = true;
    ...
    # â”€â”€ CERT: issuer bar chart â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ CERT: issuance timeline chart â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ GRAPH: ASN bar chart â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    def build_asn_chart():
        if not org_counter:
            return None
    ...
    # â”€â”€ GRAPH: country pie â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ GRAPH: port heatmap â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Page 1: Cover / header â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    story.append(HRFlowable(width=PW, thickness=4, color=C_RED, spaceAfter=0))

    # Dark header band
    hdr_inner = Table([
        [
            Paragraph(f'<font color="#f85149"><b>â¬¡</b></font>', S("logo", fontSize=28, leading=32, textColor=C_RED)),
            Table([
                [Paragraph("Infrastructure Recon Report", s_h1)],
                [Paragraph(f'<font color="#f85149">OSINT PH  Â·  osintph.info</font>',
                            S("tl", fontSize=9, fontName="Helvetica-Bold", textColor=C_RED, leading=13))],
                [Paragraph(f'Target: <font color="#58a6ff"><b>{domain}</b></font>  Â·  '
                           f'Investigated: {created}  Â·  Generated: {dt.now(timezone.utc).replace(tzinfo=None).strftime("%Y-%m-%d %H:%M UTC")}',
    ...
    # â”€â”€ Stat strip â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    stat_items = [
        ...
        ("âš  YES" if zt_success else "âœ“ NO", "ZONE XFR"),
        ("âœ“" if email_sec.get("spf_valid") else "âœ—", "SPF"),
        ("âœ“" if email_sec.get("dmarc_valid") else "âœ—", "DMARC"),
    ]
    stat_colors = {
        "âš  YES": C_RED, "âœ“ NO": C_GREEN,
        "âœ“": C_GREEN, "âœ—": C_RED,
    }
    stat_cells = []
    ...
    # â”€â”€ Zone transfer alert â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if zt_success:
        ns_vuln = [ns for ns, info in zt.items() if isinstance(info, dict) and info.get("success")]
        alert_tbl = Table([[
            Paragraph("ðŸš¨", S("alertico", fontSize=16, leading=20)),
    ...
    # â”€â”€ Email security issues â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    issues = email_sec.get("issues", [])
    if issues:
        for issue in issues:
            story.append(Paragraph(f"âš  {issue}", s_warn))
        story.append(Spacer(1, 4))

    # â”€â”€ Page 1: Infrastructure overview (charts side by side) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ World map â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    wmap = None
    if cc_counter:
        try:
    ...
    # â”€â”€ Subdomain graph â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    story.append(PageBreak())
    section_header("Subdomain Infrastructure Graph")
    story.append(Paragraph(
        f"{len(resolved)} passive subdomains Â· {len(bruteforce)} brute-forced Â· "
    ...
    # â”€â”€ DNS Records â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    section_header("DNS Records")
    rec_rows = []
    for rtype in ["A", "AAAA", "MX", "NS", "TXT", "CNAME", "SOA", "CAA"]:
        for val in dns.get(rtype, []):
            geo = ip_geo.get(val, {})
            geo_s = f"{geo.get('city','')} {geo.get('country','')} Â· {geo.get('org','')}".strip(" Â·")
            ptr_s = ptr.get(val, "")
            rec_rows.append([
    ...
    # â”€â”€ Email security â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    esec_data = [
        ...
        [Paragraph("SPF", s_body),
         Paragraph("âœ“ Valid" if spf_v else "âœ— Missing", S("sv2", fontSize=8, fontName="Helvetica-Bold", textColor=C_GREEN if spf_v else C_RED, leading=12)),
         Paragraph(email_sec.get("spf") or "â€”", s_mono)],
        [Paragraph("DMARC", s_body),
         Paragraph("âœ“ Valid" if dmarc_v else "âœ— Missing", S("dv2", fontSize=8, fontName="Helvetica-Bold", textColor=C_GREEN if dmarc_v else C_RED, leading=12)),
         Paragraph(email_sec.get("dmarc") or "â€”", s_mono)],
        [Paragraph("DKIM", s_body),
         Paragraph(f"âœ“ {len(dkim_sel)} selector(s)" if dkim_sel else "âœ— Not detected",
    ...
    # â”€â”€ Subdomains table â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    section_header(f"Resolved Subdomains ({len(resolved)} passive Â· {len(bruteforce)} brute-forced)")
    ...
    # â”€â”€ Certificate Transparency (rich version if available) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if passive:
        ...
        if rich_cert_data and rich_cert_data.get("total", 0) > 0:
            cd = rich_cert_data
            section_header(f"Certificate Transparency â€” {cd['total']} certificates")
            ...
            # Cert table â€” show all, colour-code expired/expiring
            cert_rows = []
            for c in cd["certs"][:150]:
                is_exp = c.get("is_expired")
                exp_soon = c.get("expiring_soon")
                days = c.get("days_remaining")
                status_txt = "EXPIRED" if is_exp else (f"âš  {days}d" if exp_soon else "âœ“ Active")
                status_col = C_RED if is_exp else (C_YELLOW if exp_soon else C_GREEN)
                san_preview = (c["sans"][0] if c.get("sans") else "â€”")
                issuer_s = (c.get("issuer_org") or "â€”")[:32]
                cert_rows.append([
            ...
            section_header(f"Certificate Transparency â€” {len(passive)} crt.sh certificates")
            cert_rows = []
    ...
    if port_scan:
        ...
        for ip, ports in port_scan.items():
            ...
            if not open_p and not filt_p:
                continue
            story.append(Paragraph(
                f'<font color="#58a6ff"><b>{ip}</b></font> â€” '
    ...
    # â”€â”€ Directory enumeration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if dir_enum:
        ...
        if interesting_total:
            section_header(f"Directory Enumeration â€” {interesting_total} paths found")
            for target, paths in dir_enum.items():
                interesting = [p for p in paths if p.get("status_code") not in (404, 410)]
                if not interesting:
                    continue
                story.append(Paragraph(
                    f'<font color="#58a6ff"><b>{target}</b></font> â€” {len(interesting)} paths',
                ...
                for p in interesting:
                    ...
                    dir_rows.append([
                        ...
                        Paragraph(p.get("content_length","") or "â€”", s_small),
                        Paragraph(p.get("redirect_to","") or "â€”", s_small),
                    ])
                story.append(dark_table(
    ...
    # â”€â”€ Zone transfer detail â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if zt_success:
        section_header("Zone Transfer Records â€” CRITICAL", C_RED)
        for ns, info in zt.items():
            if not info.get("success"):
                continue
            story.append(Paragraph(f"Nameserver: {ns} â€” {info.get('record_count',0)} records exposed", s_warn))
            zt_rows = [
    ...
    story.append(Spacer(1, 4))
    story.append(Paragraph(
        f"CONFIDENTIAL â€” Infrastructure Recon Report  Â·  OSINT PH / osintph.info  Â·  "
        f"Target: {domain}  Â·  Report ID: OSINTPH-DNS-{inv_id}-{dt.now(timezone.utc).replace(tzinfo=None).strftime('%Y%m%d')}",
        s_foot))
...
# GöÇGöÇ Quick Scan GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
